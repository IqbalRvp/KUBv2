...
if(isset($_POST['Submit'])) {
    ...
    $sql = "INSERT INTO brg_telur(gread,berat_telur) VALUES('$gread','$berat_telur')";
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="text-center d-none d-md-inline">
                ...
                ?>
                <form action="tambah_brg_tlr.php" method="POST" name="Tambah_telur">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="berat_telur">
                    </div>
