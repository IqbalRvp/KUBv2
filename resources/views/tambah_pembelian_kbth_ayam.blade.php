...
<body>
    ...
    <form action="tambah_pembelian_kbth_ayam.blade.php" method="post" name="form1">
        ...
        <a href="pembelian_kbth_aym.blade.php">kembali</a>
    </form>
    <?php
...
if(isset($_POST['Submit'])) {
   ...
   location.replace('pembelian_kbth_aym.blade.php');
   </script>";
