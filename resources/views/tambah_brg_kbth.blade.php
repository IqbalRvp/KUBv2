...
if(isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($conn, "INSERT INTO brg_kbth_ayam(nama_kbth, jumlah_kbth) VALUES('$nama_kbth','$jumlah_kbth')");
            ...
            <div class="text-center d-none d-md-inline">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="jumlah_kbth">
